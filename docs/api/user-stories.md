...
### US-007: 포인트 기반 결제
**As a** 고객
**I want** 내 계정 포인트로 주문 금액을 결제할 수 있다
**So that** 신속하게 구매를 완료할 수 있다

**Acceptance Criteria:**
- [ ] 사용자의 현재 포인트를 조회할 수 있다
- [ ] 주문 금액만큼 포인트가 차감된다
- [ ] 포인트가 부족한 경우 결제가 실패하고 적절한 에러 메시지가 표시된다
...
### US-015: 포인트 조회
**As a** 고객
**I want** 내 계정의 현재 포인트를 확인할 수 있다
**So that** 구매 가능한 금액을 파악할 수 있다

**Acceptance Criteria:**
- [ ] 현재 사용 가능한 포인트를 조회할 수 있다
- [ ] 포인트 변동 이력을 확인할 수 있다 (충전, 사용)
